...
class RekapAbsensiController extends Controller
{
    ...
    {
        $index = DB::table('rekapabsensisiswa')->paginate(10);
        ...
        return view('pages.rekapan_absensi.index', compact('index', 'kelas', 'mapel'));
    }
    ...
    public function print(Request $request)
    {
        ...
        if($id1 != null && $id2 != null)
        {
            ...
            if($get != null){
                ...
                return redirect('rekapabsensisiswa/view')->with(['failed' => 'Data tidak ditemukan!']);
            }
        }else
        {
            return redirect('rekapabsensisiswa/view')->with(['failed' => 'Data tidak ditemukan!']);
