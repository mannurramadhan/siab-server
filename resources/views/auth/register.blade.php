@extends('layouts.app', [
    'class' => 'register-page',
    'title' => 'Register - SIAB SMAN 2 Kota Balikpapan',
    'titlepage' => '',
                ...
                <div class="col-lg-4 col-md-6 mr-auto">
                    <div class="card card-signup text-center">
                        <div class="card-header ">
                            <h4 class="card-title">{{ __('Daftar Akun') }}</h4>
                            <!--<div class="social">
                        ...
                        <div class="card-body ">
                            <form class="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="input-group{{ $errors->has('nip_niph') ? ' has-danger' : '' }}">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <i class="nc-icon nc-badge"></i>
                                        </span>
                                    </div>
                                    <input name="nip_niph" type="text" class="form-control" placeholder="NIP / NIPH" required value="{{ old('nip_niph') }}">
