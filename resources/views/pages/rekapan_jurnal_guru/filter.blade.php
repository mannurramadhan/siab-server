@extends('layouts.app', [
    'class' => '',
    'title' => 'Rekapan Jurnal Guru - SIAB SMAN 2 BALIKPAPAN',
    'titlepage' => 'Rekapan Jurnal Guru',
    'elementActive' => 'rjg'
])
                ...
                <div class="card" style="width: 29rem;">
                    <div class="card-header">
                        ...
                        <?php
                            ...
                            $namaMapel=0;
                        ?>  
                        <form action="{{ route('filter.rba') }}" method="GET">
                        ...
                        <form action="{{ route('print.rba') }}" method="GET" target="_blank">
