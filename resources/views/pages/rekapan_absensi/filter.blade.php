@extends('layouts.app', [
    'class' => '',
    'title' => 'Rekapan Absensi Siswa - SIAB SMAN 2 BALIKPAPAN',
    'titlepage' => 'Rekapan Absensi Siswa',
    'elementActive' => 'ras'
])
    ...
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card" style="width: 29rem;">
                    <div class="card-header">
                        ...
                        <?php
                            ...
                            $namaMapel=0;
                        ?>  
                        <form action="{{ route('filter.ras') }}" method="GET">
                        ...
                        <form action="{{ route('print.ras') }}" method="GET" target="_blank">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Tabel Rekapan Absensi Siswa') }}</h4>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach($index as $rekapabsensi)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo(date('d-m-Y', strtotime($rekapabsensi->Bulan))) ?></td>
